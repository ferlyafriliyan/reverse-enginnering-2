...
import platform;from rich import print
import marshal, zlib, base64
import binascii, lzma, bz2, gzip
from os import system as auto;import os, sys
...
input_file = input(f"{Biru_muda}[{Hijau}•{Biru_muda}]{Putih} Input File {Hijau}: {Putih}")

# Request file output

output_file = input(f"{Biru_muda}[{Hijau}•{Biru_muda}]{Putih} Output File {Hijau}: {Putih}")
...
def encrypt_file():
    ...
    for _ in range(num_iterations):
        ...
        with open(output_path, 'w') as file:
            ...
            file.write(f'import datetime, platform, marshal, zlib, base64, binascii, os\n\n')
            ...
            file.write(f'code = marshal.loads(zlib.decompress(base64.b64decode(decrypted_data)))\n')
