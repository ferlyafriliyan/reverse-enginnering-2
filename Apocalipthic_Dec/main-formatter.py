...
__builtins__.bbllaacckk_thanks_to_nguyen=__import__(_O)
__builtins__.hjjhjhjhjllkfklsfuuiudfhaf=__import__(_A)
__builtins__.lolololo1lo1l1o1l1ol11o1olo00ioooOOO=__import__('marshal')
__builtins__.ljljljljl11j1jjl1j1jl1j1jl1lljooOo=__import__('binascii').unhexlify
__builtins__.jl1j1l1l1j1ljOOO000LLJJLJL=__import__('io').BytesIO
__builtins__.bbllaacckk_stdout__=__import__(_A).stdout
__builtins__.bbllaacckk_nhung_modules_bi_khoa=['os','threading',_O,_A]
...
except NameError:__cpy_syspath__=__builtins__.hjjhjhjhjllkfklsfuuiudfhaf.executable
class bbllaacckk_KhanhNguyen__bot:
	def rm_pycache():
		try:__import__(_P).rmtree('__pycache__')
		except:pass
	def get_py_ver():return'.'.join(__builtins__.hjjhjhjhjllkfklsfuuiudfhaf.version.split(' ')[0].split('.')[:-1])
	...
	def get_license(file_name,bbllaacckk_day_la_binary):return f"# File name: [{file_name}.py] (".encode(_G)+str('pyc'if bbllaacckk_day_la_binary else'py').encode(_G)+' - '.encode(_G)+__builtins__.bbllaacckk_KhanhNguyen__bot.get_py_ver().encode(_G)+')\n\n'.encode(_G)
	...
	def put_code(self,content):self.content=list(__builtins__.bbllaacckk_deobfuscate_tokenize.tokenize(__builtins__.jl1j1l1l1j1ljOOO000LLJJLJL(content).readline))
	...
	def read(bbllaacckk_ten_cua_file_code_bi_ma_hoa_tum_lum,bbllaacckk_day_la_binary,is_dump=_E):
		L='!! failed when deobfuscate!';K='[!!] cannot auto detect real code! please manually input code+vars if you can!';J='[::-1]))),globals())';I='exec(__import__("marshal").loads(__import__("zlib").decompress(__import__("base64").b64decode(';H='base64';G='_py';F='temp_run.py';E='zlib';D='exec';C='<IIIIIIIII111II1I1llllll1l1l1ll1i>';B='jlljjjlljl111ll111llj.py';A='temp_code.py';print('[>>] Reading file....')
...
print(__import__(_A).version)
while 1:
	inp=input('!! Auto Detect Code + Vars? [Y/n]: ').lower()
	if inp=='y':
		while 1:
			try:
				__builtins__.bbllaacckk_ten_cua_file_code_bi_ma_hoa_tum_lum=input('<< Input full file Hyperion: ').replace('"','');__builtins__.bbllaacckk_sieu_nhan_gao_xanh=open(__builtins__.bbllaacckk_ten_cua_file_code_bi_ma_hoa_tum_lum,_C).read(4)
				...
				break
			except FileNotFoundError:print(_K)
			except PermissionError:print(_L)
		...
		while 1:
			...
			if inp=='y':
				...
				__builtins__.bbllaacckk_day_la_binary=_E;print('[!!] You must Deobfuscate the First Layer Apocalipthyc Into a File First!')
				while 1:
					try:
				...
				print('>> Reading File....');__builtins__.bbllaacckk_sieu_nhan_gao_do=open(__builtins__.bbllaacckk_ten_cua_file_code_bi_ma_hoa_tum_lum,_C).read().split(_B);break
...
print('>> Split Code....')
for __builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh in range(0,len(__builtins__.bbllaacckk_sieu_nhan_gao_do),1):
	if b'from builtins import 'in __builtins__.bbllaacckk_sieu_nhan_gao_do[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh]:__builtins__.bbllaacckk_sieu_nhan_gao_xanh=__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh;__builtins__.bbllaacckk_ignore_var_by_khanh=_D;break
__builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai=0
__builtins__.bbllaacckk_line_removed=0
if _S not in __builtins__.bbllaacckk_sieu_nhan_gao_do[0]:
	print('>> Remove __license__ ....')
	for __builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh in range(0,len(__builtins__.bbllaacckk_sieu_nhan_gao_do),1):
		if _S in __builtins__.bbllaacckk_sieu_nhan_gao_do[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh]:__builtins__.bbllaacckk_sieu_nhan_gao_do=__builtins__.bbllaacckk_sieu_nhan_gao_do[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh:];__builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai=__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh;__builtins__.bbllaacckk_line_removed=__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh;break
if __builtins__.bbllaacckk_ignore_var_by_khanh:print('[>>] Code Detected! try Deobfuscate Completely....');__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh=_B.join(__builtins__.bbllaacckk_sieu_nhan_gao_do[:__builtins__.bbllaacckk_sieu_nhan_gao_xanh-__builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai]);__builtins__.bblbbbkasdslkasjdasok__Faskm=_B.join(__builtins__.bbllaacckk_sieu_nhan_gao_do[__builtins__.bbllaacckk_sieu_nhan_gao_xanh-__builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai:]);__builtins__.bbllaacckk_cuoc_doi_that_dep_lam_sao=_E
else:
	print('[>>] Code Undetected ! only Deobfuscate Vars....');__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh=_B.join(__builtins__.bbllaacckk_sieu_nhan_gao_do);__builtins__.bblbbbkasdslkasjdasok__Faskm=_B.join(__builtins__.bbllaacckk_sieu_nhan_gao_do);__builtins__.bbllaacckk_cuoc_doi_that_dep_lam_sao=_D;print('[!!] only deobfuscate vars is NOT recommend to reading vars !!')
	while 1:
...
if __builtins__.bbllaacckk_ignore_var_by_khanh:
	__builtins__.bbllaacckk_ignore_var_by_khanh=['__cpy_syspath__','__name__','exit','__doc__','__file__','__cached__','__package__','__loader__','__spec__','__annotations__','__builtins__','__warningregistry__'];print('[>>] Prevent __import__ ....');__builtins__.bbllaacckk_chan_quyen_thoat_code=vars(__import__(_A)).copy();__import__(_A).exit=_I;__import__(_M).exit=_I;exit=_I;__builtins__.bbllaacckk_backup_modules_vip_pro={}
	for __builtins__.bbllaacckk_khanh_dep_trai_qua in __builtins__.bbllaacckk_nhung_modules_bi_khoa:
		try:__builtins__.bbllaacckk_backup_modules_vip_pro[__builtins__.bbllaacckk_khanh_dep_trai_qua]=__builtins__.hjjhjhjhjllkfklsfuuiudfhaf.modules[__builtins__.bbllaacckk_khanh_dep_trai_qua];__builtins__.hjjhjhjhjllkfklsfuuiudfhaf.modules[__builtins__.bbllaacckk_khanh_dep_trai_qua]=_I
		except KeyError:pass
	print('[>>] Reading vars....');print('================ [Use: <Ctrl + C> if code started!]\n');__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh=__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh.split(_B);__builtins__.bbllaacckk_max__=len(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh);__builtins__.bbllaacckk_min__=0
	for __builtins__.bbllaacckk_khanh_dep_trai_qua in __builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh:
		try:exec(__builtins__.bbllaacckk_khanh_dep_trai_qua,globals());__builtins__.index=int(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh.index(__builtins__.bbllaacckk_khanh_dep_trai_qua))+1;__builtins__.i=int(100/(__builtins__.bbllaacckk_max__-__builtins__.bbllaacckk_min__)*(__builtins__.index-__builtins__.bbllaacckk_min__));__builtins__.bbllaacckk_stdout__.write(f"\r[%-25s] %d%% ({__builtins__.index}/{__builtins__.bbllaacckk_max__})"%('='*int(__builtins__.i/4),__builtins__.i));__builtins__.bbllaacckk_stdout__.flush()
		except KeyboardInterrupt:print('\n!! break read vars [KeyboardInterrupt] !!');print(_N.format(int(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh.index(__builtins__.bbllaacckk_khanh_dep_trai_qua))+__builtins__.bbllaacckk_line_removed+1),end='');break
		except Exception as e:print('\n!! stop read vars due to [{}] !!'.format(str(e)));print(_N.format(int(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh.index(__builtins__.bbllaacckk_khanh_dep_trai_qua))+__builtins__.bbllaacckk_line_removed+1),end='');break
		except:print('\n!! stop read vars due to [unknown error] !!');print(_N.format(int(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh.index(__builtins__.bbllaacckk_khanh_dep_trai_qua))+__builtins__.bbllaacckk_line_removed+1),end='');break
	...
	for __builtins__.bbllaacckk_khanh_dep_trai_qua in __builtins__.bbllaacckk_backup_modules_vip_pro:
		try:__builtins__.hjjhjhjhjllkfklsfuuiudfhaf.modules[__builtins__.bbllaacckk_khanh_dep_trai_qua]=__builtins__.bbllaacckk_backup_modules_vip_pro[__builtins__.bbllaacckk_khanh_dep_trai_qua]
		except KeyError:pass
	exit=__builtins__.bbllaacckk_chan_quyen_thoat_code['exit'];__import__(_A).exit=exit;__import__(_M).exit=exit;__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh={};__builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai=1
	for __builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai in globals():
		...
		elif __builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai in __import__(_M).__dict__:continue
		__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[__builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai]=globals()[__builtins__.bbllaacckk_dep_trai_thi_khong_co_gi_la_sai]
	__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh=dict(sorted(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh.items(),key=lambda x:(len(x[0]),len(x[0])),reverse=_D));unhexlify_name='__builtins__.ljljljljl11j1jjl1j1jl1j1jl1lljooOo';eval_name='eval';mot_dong_string_rat_dai=[str(char).encode()for char in'qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890']
	...
	if not __builtins__.bbllaacckk_cuoc_doi_that_dep_lam_sao:
		...
		if __builtins__.bbllaacckk_replace_type==1:Khanh=__builtins__.bbllaacckk_KhanhNguyen__bot();Khanh.put_code(__builtins__.bblbbbkasdslkasjdasok__Faskm)
		__tmp_list__=list(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh);__builtins__.bbllaacckk_max__=len(__tmp_list__);__builtins__.bbllaacckk_min__=0
		for bbllaacckk_khanh_dep_trai_nhat in __builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh:
			if len(bbllaacckk_khanh_dep_trai_nhat)>=1:
				if bbllaacckk_khanh_dep_trai_nhat.encode()in __builtins__.bblbbbkasdslkasjdasok__Faskm:
					__builtins__.bbllaacckk___tmp_var__=str(type(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat]))
					if __builtins__.bbllaacckk___tmp_var__=="<class 'bool'>"or __builtins__.bbllaacckk___tmp_var__=="<class 'int'>"or __builtins__.bbllaacckk___tmp_var__=="<class 'float'>":__builtins__.bbllaacckk_khanh_number_one=str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat])
					elif __builtins__.bbllaacckk___tmp_var__==_T:__builtins__.bbllaacckk_khanh_number_one=str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat]).split(' ')[1]
					elif __builtins__.bbllaacckk___tmp_var__=="<class 'builtin_function_or_method'>":
						__builtins__.bbllaacckk___tmp_var__=str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat]).split(' ')[-1][:-1]
					...
					elif __builtins__.bbllaacckk___tmp_var__==_T:
						__builtins__.bbllaacckk_khanh_number_one=str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat])
						if'<function <lambda> at 'in __builtins__.bbllaacckk_khanh_number_one:continue
						else:__builtins__.bbllaacckk_khanh_number_one=' '.join(str(__builtins__.bbllaacckk_khanh_number_one).split(' ')[:-2][-1:])+"() '''args: {}'''".format(str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat].__code__.co_varnames))
					elif __builtins__.bbllaacckk___tmp_var__=="<class 'type'>":__builtins__.bbllaacckk_khanh_number_one=str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat]).split(' ')[1].split('.')[-1][:-2]
					elif __builtins__.bbllaacckk___tmp_var__=="<class 'bytes'>":__builtins__.bbllaacckk_khanh_number_one=str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat]).replace('\r','\\r').replace('\n','\\n').replace('\t','\\t')
					else:__builtins__.bbllaacckk_khanh_number_one=str('"'+str(__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh[bbllaacckk_khanh_dep_trai_nhat]).replace(_F,'\\\\').replace('"','\\"')+'"').replace('\n','\\n').replace('\t','\\t').replace('\r','\\r').replace('\x08','\\b').replace('\x0c','\\f')
					...
					elif __builtins__.bbllaacckk_replace_type==0:__builtins__.bblbbbkasdslkasjdasok__Faskm=__builtins__.bbllaacckk_KhanhNguyen__bot.replace_by_khanh_dep_trai(__builtins__.bblbbbkasdslkasjdasok__Faskm,bbllaacckk_khanh_dep_trai_nhat.encode(),__builtins__.bbllaacckk_khanh_number_one.encode())
		...
		if __builtins__.bbllaacckk_replace_type==1:__builtins__.bblbbbkasdslkasjdasok__Faskm=Khanh.get_code()
	if _J.format(unhexlify_name).encode()in __builtins__.bblbbbkasdslkasjdasok__Faskm:
		if input('!! found unhexlify! do you want to decode it? [Y/n]: ').lower()=='y':
			print('>> fixing unhexlify [this may take too long]....');song_chet_co_so='{}({}('.format(eval_name,unhexlify_name).encode();__builtins__.bblbbbkasdslkasjdasok__Faskm=__builtins__.bblbbbkasdslkasjdasok__Faskm.split(_B);__builtins__.bbllaacckk_khanh_number_one=b'';__builtins__.bbllaacckk_max__=len(__builtins__.bblbbbkasdslkasjdasok__Faskm);__builtins__.bbllaacckk_min__=0
			for bbllaacckk_khanh_dep_trai_nhat in range(0,len(__builtins__.bblbbbkasdslkasjdasok__Faskm),1):
				if _J.format(unhexlify_name).encode()in __builtins__.bblbbbkasdslkasjdasok__Faskm[bbllaacckk_khanh_dep_trai_nhat]:
					ghe_vay_sao=__builtins__.bblbbbkasdslkasjdasok__Faskm[bbllaacckk_khanh_dep_trai_nhat].split(b'=')
					for __builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh in range(0,len(ghe_vay_sao),1):
						if _J.format(unhexlify_name).encode()in ghe_vay_sao[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh]:
							__builtins__.bbllaacckk___tmp_var__=ghe_vay_sao[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh]
							while 1:
									...
									if __builtins__.bbllaacckk___tmp_var__[:len(eval_name)+len(unhexlify_name)+2]==song_chet_co_so:
										while len(__builtins__.bbllaacckk___tmp_var__)>len(eval_name)+len(unhexlify_name)+2:
											try:
												...
												__builtins__.bbllaacckk_khanh_number_one=ghe_vay_sao[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh].replace(__builtins__.bbllaacckk___tmp_var__,__builtins__.bbllaacckk_khanh_number_one);break
										...
										while len(__builtins__.bbllaacckk___tmp_var__)>len(unhexlify_name)+1:
											try:__builtins__.bbllaacckk_khanh_number_one=eval(__builtins__.bbllaacckk___tmp_var__).encode();__builtins__.bbllaacckk_khanh_number_one=ghe_vay_sao[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh].replace(__builtins__.bbllaacckk___tmp_var__,__builtins__.bbllaacckk_khanh_number_one);break
											except Exception:__builtins__.bbllaacckk___tmp_var__=__builtins__.bbllaacckk___tmp_var__[:-1]
										break
									else:__builtins__.bbllaacckk___tmp_var__=__builtins__.bbllaacckk___tmp_var__[1:]
								if _J.format(unhexlify_name).encode()in __builtins__.bbllaacckk_khanh_number_one:ghe_vay_sao[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh]=__builtins__.bbllaacckk_khanh_number_one;__builtins__.bbllaacckk___tmp_var__=__builtins__.bbllaacckk_khanh_number_one;continue
								if not __builtins__.bbllaacckk___tmp_var__:__builtins__.bbllaacckk_khanh_number_one=ghe_vay_sao[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh]
								break
							ghe_vay_sao[__builtins__.bblsldijasdoiFIA__kontolodon__lajaljdshiuadh]=__builtins__.bbllaacckk_khanh_number_one
					__builtins__.bblbbbkasdslkasjdasok__Faskm[bbllaacckk_khanh_dep_trai_nhat]=b'='.join(ghe_vay_sao)
			...
			__builtins__.bbllaacckk_stdout__.write(f"\r[=========================] 100% ({__builtins__.bbllaacckk_max__}/{__builtins__.bbllaacckk_max__} unhexlify)");__builtins__.bbllaacckk_stdout__.flush();print('');__builtins__.bblbbbkasdslkasjdasok__Faskm=_B.join(__builtins__.bblbbbkasdslkasjdasok__Faskm)
		else:__builtins__.bblbbbkasdslkasjdasok__Faskm=b'from binascii import unhexlify\n'+__builtins__.bblbbbkasdslkasjdasok__Faskm
	__builtins__.bblbbbkasdslkasjdasok__Faskm=__builtins__.bblbbbkasdslkasjdasok__Faskm.replace(unhexlify_name.encode(),b'unhexlify')
file_name,folder=__builtins__.bbllaacckk_KhanhNguyen__bot.get_f_d(__builtins__.bbllaacckk_ten_cua_file_code_bi_ma_hoa_tum_lum)
print(f">> Saving.... [DEC-{file_name}.py]")
open(f"{folder}DEC-{file_name}.py",'wb').write(__builtins__.bbllaacckk_KhanhNguyen__bot.get_license(file_name,__builtins__.bbllaacckk_day_la_binary)+__builtins__.bblbbbkasdslkasjdasok__Faskm)
print('[>>] Done !')